...
public class ClinicFinderApplicationServiceTest {
	...
	@Autowired
	ClinicFinderApplicationService clinicFinderApplicationService;
	...
	public void testGetNearestClinic() throws Exception {
		Request request = new Request();
		request.setLocationData(new LocationData(18.417606, -33.933782));
		Clinic clinic = ((ClinicFinderApplicationServiceImpl)clinicFinderApplicationService).getNearestClinic(request);
	...
	public void testGetSmsText() throws Exception {
		...
		String smsText = ((ClinicFinderApplicationServiceImpl)clinicFinderApplicationService).getSmsText(clinic);
	...
	public void testUpdateUssdClinicFinder() throws Exception {
		...
		UssdClinicFinder datamart1 = new UssdClinicFinder("567", new Date(), "2767879872", "1", 1.22, 3.44);
		ussdClinicFinderRepository.save(datamart1);
		((ClinicFinderApplicationServiceImpl)clinicFinderApplicationService).updateUssdClinicFinder(request, clinic, smsText);
